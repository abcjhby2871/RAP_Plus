...
from select_multi_frame import select_special_frames
...
def main(args):
    ...
    if args.video_file:
        ...
        task_images = select_special_frames(video_path=args.video_file)
        images = copy.deepcopy(task_images)
        image_sizes = []
